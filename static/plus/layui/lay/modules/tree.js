...
function(e) {
    ...
    g.prototype.tree = function(e, a) {
        ...
        function(a, l) {
        	// console.log(l);
        	// console.log(icon);
        	var icon = typeof(l.icon) != "undefined" ? "&nbsp;&nbsp;<i class='layui-icon " + l.icon + "' style='font-size:14px;'></i>" : "";
            ...
            function() {
                return r.isJump && l.href ? '<a href="' + l.href + '" target="_blank" class="' + p + '">' + (l.title || l.label || r.text.defaultNodeName) + "</a>" + icon: '<span class="' + p + (l.disabled ? " " + d: "") + '">' + (l.title || l.label || r.text.defaultNodeName) + "</span>" + icon
            } (), "</div>",
            function() {
                if (!r.edit) return "";
                var e = {
